...
class GirlFriendAIConfig(TelegramBotConfig):
    bot_token: str = Field(TOKEN)
    chat_ids: str = Field(default=" ", description="Comma separated list of whitelisted chat_id's")
    personality: str = Field("personality/katya.json")
    use_gpt4: bool = Field(True)
