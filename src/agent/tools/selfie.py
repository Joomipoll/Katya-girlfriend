...
NEGATIVE_PROMPT = "easynegative,(deformed, distorted,disfigured:1.3), poorly drawn, bad anatomy, wrong anatomy, extra limb, missing limb, (mutated hands and finger:1.4), disconnected limbs, mutation, mutated, ugly, disgusting, blurry, amputation"
